...
def create_ticket(train_name,train_start_time,train_end_time,people_place,ticket_number,from_city,to_city):
    img = Image.open("ticket.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype('fon_italic.ttf',50)
    font_junash=ImageFont.truetype('fon_italic.ttf',45)
    font_vil=ImageFont.truetype('fon_italic.ttf',40)
    draw.text((540, 15),f"{train_name} 20-aprel",(255,255,255),font=font)
...
create_ticket('ToshSam','12:43','19:43',32,76,'Toshkent','Samarqand')
